...
Code, доставляется ещё в девять харнессов (Cursor, Codex, Antigravity,
OpenCode, Kilo Code, Gemini CLI, Qwen Code, Goose, Hermes Agent) через
нативный механизм каждого — см. `INSTALL.md`.
