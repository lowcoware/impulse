...
**Started:** {{DATE}}
**Last update:** {{DATE}}
**Run root:** {{RUN_ROOT}}    <!-- this run's namespaced artifact dir under .impulse-goal/ (e.g. .impulse-goal/add-dark-mode-Ab3Kx9); isolates concurrent runs in the same working tree -->
