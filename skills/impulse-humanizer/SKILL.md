...
абзаца, отсутствии мнения и конкретики. Самое важное правило файла —
**факт-замок**: числа, даты, имена, цитаты переносятся неизменными, новая
конкретика не выдумывается никогда (детали ниже, «Два правила без
исключений»).
